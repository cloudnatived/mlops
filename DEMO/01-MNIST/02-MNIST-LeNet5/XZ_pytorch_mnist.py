...
train_dataset = datasets.MNIST(root='/Data/DEMO/MODEL/MNIST', train=True, transform=transform)  # 本地没有就加上download=True
test_dataset = datasets.MNIST(root='/Data/DEMO/MODEL/MNIST', train=False, transform=transform)  # train=True训练集，=False测试集
